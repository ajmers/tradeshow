defmodule TradeshowWeb.BoothsController do
  ...
  def index(conn, _params) do
    case Booths.list_booths(conn.assigns.tenant, conn.assigns.user_token) do
  ...
  def create(conn, params) do
    case Booths.create_booth(conn.assigns.tenant, conn.assigns.user_token, params) do
  ...
  def update(conn, %{"id" => id} = params) do
    ...
    case Booths.update_booth(conn.assigns.tenant, conn.assigns.user_token, id, fields) do
  ...
  def delete(conn, %{"id" => id}) do
    case Booths.delete_booth(conn.assigns.tenant, conn.assigns.user_token, id) do
