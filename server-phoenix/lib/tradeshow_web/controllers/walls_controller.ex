defmodule TradeshowWeb.WallsController do
  ...
  def index(conn, _params) do
    case Tradeshow.Walls.list_walls(conn.assigns.airtable_base_id) do
  ...
  def create(conn, params) do
    case Tradeshow.Walls.create_wall(conn.assigns.airtable_base_id, params) do
  ...
  def update(conn, %{"id" => id} = params) do
    ...
    case Tradeshow.Walls.update_wall(conn.assigns.airtable_base_id, id, fields) do
      {:ok, record} -> json(conn, record)
  ...
  def delete(conn, %{"id" => id}) do
    case Tradeshow.Walls.delete_wall(conn.assigns.airtable_base_id, id) do
